    ...
    <section class="px-6 py-8">
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
            ...
            <form method="post" action="/register" class="mt-10">
                @csrf
                <div class="mb-6">
                    <label class="blok mb-2 uppercase font-bold text-gray-700" for="name">
                ...
                <div class="mb-6">
                    <label class="blok mb-2 uppercase font-bold text-gray-700" for="username">

                        Username
                    </label>
                    <input class="border border-gray-400 p-2 w-full" type="name" name="username" id="username">
                    @error('username')
                    <p class="text-red-500">{{$massege}}}</p>
                    @enderror
